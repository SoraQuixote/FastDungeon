 ...
 */
final class Version20260427094127 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE arme (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, bonus INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE armure (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, bonus INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE attaque (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, pts_degat INT DEFAULT NULL, effet VARCHAR(200) DEFAULT NULL, portee VARCHAR(20) DEFAULT NULL, cout INT DEFAULT NULL, dtype VARCHAR(255) NOT NULL, degat_de_contre INT DEFAULT NULL, type VARCHAR(30) DEFAULT NULL, pts_de_vie INT DEFAULT NULL, type_magique_id INT DEFAULT NULL, INDEX IDX_95751B92313CAE28 (type_magique_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE campagne_plateau (campagne_id INT NOT NULL, plateau_id INT NOT NULL, INDEX IDX_D8247DE116227374 (campagne_id), INDEX IDX_D8247DE1927847DB (plateau_id), PRIMARY KEY (campagne_id, plateau_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE objet (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, pts_degat INT DEFAULT NULL, pts_de_vie INT DEFAULT NULL, effet VARCHAR(200) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE personnage (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, personnage_user VARCHAR(100) DEFAULT NULL, carnet_de_voyage LONGTEXT DEFAULT NULL, inventaire LONGTEXT DEFAULT NULL, point_de_vie INT NOT NULL, histoire LONGTEXT DEFAULT NULL, niveau INT NOT NULL, state_force INT NOT NULL, state_constitution INT NOT NULL, state_rapidite INT NOT NULL, state_intelligence INT NOT NULL, resistance_physique INT NOT NULL, resistance_magique INT NOT NULL, resistance_mentale INT NOT NULL, vie_actuelle INT DEFAULT NULL, portrait VARCHAR(255) DEFAULT NULL, user_id INT NOT NULL, armure_id INT DEFAULT NULL, arme_id INT DEFAULT NULL, INDEX IDX_6AEA486DA76ED395 (user_id), INDEX IDX_6AEA486DE4000E4F (armure_id), INDEX IDX_6AEA486D21D9C0A (arme_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE personnage_objet (personnage_id INT NOT NULL, objet_id INT NOT NULL, INDEX IDX_EC9E40025E315342 (personnage_id), INDEX IDX_EC9E4002F520CF5A (objet_id), PRIMARY KEY (personnage_id, objet_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE personnage_attaque (personnage_id INT NOT NULL, attaque_id INT NOT NULL, INDEX IDX_B96A23935E315342 (personnage_id), INDEX IDX_B96A2393118FE712 (attaque_id), PRIMARY KEY (personnage_id, attaque_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE personnage_campagne (personnage_id INT NOT NULL, campagne_id INT NOT NULL, INDEX IDX_24B072B85E315342 (personnage_id), INDEX IDX_24B072B816227374 (campagne_id), PRIMARY KEY (personnage_id, campagne_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE plateau (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, tuile VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE pnj_objet (pnj_id INT NOT NULL, objet_id INT NOT NULL, INDEX IDX_813A775E51796E0B (pnj_id), INDEX IDX_813A775EF520CF5A (objet_id), PRIMARY KEY (pnj_id, objet_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE pnj_attaque (pnj_id INT NOT NULL, attaque_id INT NOT NULL, INDEX IDX_17D9F96051796E0B (pnj_id), INDEX IDX_17D9F960118FE712 (attaque_id), PRIMARY KEY (pnj_id, attaque_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE pnj_campagne (pnj_id INT NOT NULL, campagne_id INT NOT NULL, INDEX IDX_AA62C451796E0B (pnj_id), INDEX IDX_AA62C416227374 (campagne_id), PRIMARY KEY (pnj_id, campagne_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE `role` (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(30) NOT NULL, UNIQUE INDEX UNIQ_57698A6AA4D60759 (libelle), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE type_magique (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, type VARCHAR(50) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(50) NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D64986CC499D (pseudo), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
