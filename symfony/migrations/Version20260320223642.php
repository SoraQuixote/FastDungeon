 ...
 */
final class Version20260320223642 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personnage ADD race_id INT DEFAULT NULL, ADD classe_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE personnage ADD CONSTRAINT FK_6AEA486D8F5EA509 FOREIGN KEY (classe_id) REFERENCES personnage_classe (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personnage DROP race_id, DROP classe_id');
    }
}
