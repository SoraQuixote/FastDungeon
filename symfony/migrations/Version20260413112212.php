 ...
 */
final class Version20260413112212 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personnage CHANGE vie_actuelle vie_actuelle INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personnage CHANGE vie_actuelle vie_actuelle INT NOT NULL');
